...
S[1] = {
  ...
  slides: [
    ...
    (s) => practiceSlide(s, 1, [
      ...
      "「파이프라인 실행」 → 터미널에 실제 출력 두 줄과 <class 'str'> 이 찍히고, 글자 길이 차트가 뜬다.",
    ], [
...
S[3] = {
  ...
  slides: [
    ...
    (s) => practiceSlide(s, 3, [
      ...
      "「파이프라인 실행」 → 과목별 점수 도넛과 평균. 보너스를 50 으로 내리면 평균이 얼마인지 확인.",
    ], [
...
S[5] = {
  ...
  slides: [
    ...
    (s) => practiceSlide(s, 5, [
      ...
      "「파이프라인 실행」 → 도넛 색이 등급(초록 CHALLENGER · 파랑 GOLD · 빨강 BRONZE). 커트라인을 낮추면 같은 점수가 등급이 오른다.",
    ], [
